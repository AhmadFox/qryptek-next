...
const subTitles = {
  v1: tw`block text-gray-400 capitalize text-lg xl:text-2xl font-semibold sm:text-start ml-6 xl:ml-11 mb-4 xl:mb-5`
}
...
export const Count = ({children, className }) => {
  return <span css={tw`text-gray-400 font-semibold text-sm md:text-base xl:text-lg mb-1 2xl:mb-2 3xl:mb-3`} className={className}>{children}</span>;
};